...
>
    <nav class="flex space-x-4 justify-center items-center sm:flex-1">
        <!-- <a
            href="/technology"
    ...
    <h1 class="h1 sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2">
        Chess App
    </h1>
    <div class="text-gray-600 text-xs flex flex-row sm:flex-1 sm:justify-end">
        <a
